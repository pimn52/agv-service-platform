...
| Vercel 部署 | ✅ 已上线 | https://agv.ipimn.com，GitHub push 自动部署 |
| 移动端适配 | ✅ 完成 | Safari/微信 safe-area 适配，viewport-fit=cover |
...
| 着陆页数据改用行业真实公开数据（2026-06-06） | 16,000+（新石器 CES 2026）、1 亿+ km（新石器 2026.2）、60+ 城市（九识智能 2025）。替代虚构运营数据，避免手动入口停留时间长导致的"假数据经不起审视"问题 |
